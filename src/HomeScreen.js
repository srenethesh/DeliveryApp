      ...
      switch(currentPage){
        case 'page1':
          return(
            <SafeAreaView >
            <View>
              <Text style={{fontSize:24,fontWeight:400,textAlign:'left',marginLeft:10,marginTop:20}}>Today Order</Text>
            </View>
            ...
            <View style={{width:373,height:213,borderWidth:1,borderRadius:10,backgroundColor:'#D2F4D6'}}>
              ...
              <View style={{flexDirection:'row',justifyContent:'space-evenly',marginTop:20}}>
                <View style={{width:121,height:40,borderWidth:1,borderRadius:20,justifyContent:'center',backgroundColor:'#F2EBD9'}}>
                  <Text style={{textAlign:'center',fontSize:12,fontWeight:400,color:'#364A15'}}>{Details.button1}</Text>
                </View>
                <View style={{width:121,height:40,borderWidth:1,borderRadius:20,justifyContent:'center',backgroundColor:'#F2EBD9'}}>
